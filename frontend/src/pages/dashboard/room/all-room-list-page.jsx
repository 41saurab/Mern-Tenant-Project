...
const AllRoomListPage = () => {
    ...
    const loadRooms = async ({ page = 1, search = null }) => {
        setLoading(true);
        try {
            const response = await roomSvc.getRooms({ page: page, search: search });
    ...
    return (
        <div className="mb-12">
            <div className="flex my-6 justify-between items-center ">
                <PageHeaderNoUnderlineComponent label={"Room list"} />
...
export default AllRoomListPage;
